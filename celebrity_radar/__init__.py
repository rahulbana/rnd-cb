...
different angle and source set) that run concurrently against Anthropic's server-side
web search tool, then a synthesis agent merges their cited findings into one report.
"""
